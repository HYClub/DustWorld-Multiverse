(function () {
  ...
  var MAX_POP_BASE = [50, 200, 500, 1000, 3000, 8000, 20000];
  var LEVEL_UP_POP = [35, 150, 400, 800, 2500, 6000, 15000];
  ...
  // Utility: parse config with defaults
  ...
  WorldEngine.prototype.setCivilization = function(eraId, civId, leaderId, civData) {
    if (!civData && globalThis.CivEngine) civData = globalThis.CivEngine.getCiv(eraId, civId);
  ...
  if (typeof globalThis !== 'undefined') globalThis.WorldEngine = WorldEngine;
